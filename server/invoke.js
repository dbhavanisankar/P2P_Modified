...
var order = fabric_client.newOrderer('grpcs://nc72ac8e335ef4507a137de7a1a2fe4ea-orderer.us05.blockchain.ibm.com:31001',{pem:creds.orderers.orderer.tlsCACerts.pem,'ssl-target-name-override': null});
//
...
Fabric_Client.newDefaultKeyValueStore({ path: store_path
	...
	if (isProposalGood) {
		...
		event_hub.setPeerAddr('grpcs://nc72ac8e335ef4507a137de7a1a2fe4ea-org1-peer1.us05.blockchain.ibm.com:31003',{pem:creds.orderers.orderer.tlsCACerts.pem,'ssl-target-name-override': null});
	...
	if(results && results[0] && results[0].event_status === 'VALID') {
	...
	return reply('Failed to send transaction due to error: ' + err.stack ? err.stack :
            err);
});
};